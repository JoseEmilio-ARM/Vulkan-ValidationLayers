...
class ValidationObject {
    public:
        ...
        std::unique_lock<std::mutex> validation_object_lock;
        virtual void write_lock() { validation_object_lock.lock(); }
        virtual void write_unlock() { validation_object_lock.unlock(); }
